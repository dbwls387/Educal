              ...
              <div class="tableTestBox">
                <table class="table table-borderless scoreTable" align="center">
                  ...
                  <tbody>
                    ...
                    >
                      <td class="aa">
                        <div class="row abb" @click="getDetailScore(test.test_info_id)">
                          <div class="col-1">
                          </div>
                          <div class="col-8 test_info_name">
                            {{ test.test_info_name }}
                          </div>
...
export default {
  ...
  setup() {
    ...
    function updateMonth(date) {
      selectedDay.value = String(parseInt(date) + 1)
      getScoreList()
    }
    ...
    // const store = useStore();
    // const students = store.state.classStudent;
    // const testData = ref([]);
